...
struct SalePolicy_DiscountView: View {
    ...
    @Binding var isShowComboboxDiscout: Bool
    @Binding var selectedComboDiscout: Int
    @Binding var isChangeColor: Bool
    @Binding var selectedComboDiscoutName: String
    @State var strPay = ""
    @State var strPayDiscount = ""
        ...
        VStack(spacing: 0) {
            VStack(spacing: 0) {
                ...
                VStack (alignment: .leading, spacing: H(8)) {
                    ...
                    Button(action: {
                        self.isShowComboboxDiscout = true
                            ...
                            HStack {
                                ZStack (alignment: .leading) {
                                    TextCustom(text: NSLocalizedString("sale_policy_pickup_progress", comment: ""), font: ITALIC, size: 14, color: #colorLiteral(red: 0.665820241, green: 0.6659018993, blue: 0.6657924652, alpha: 1))
                                        .opacity(selectedComboDiscout == -1 ? 1 : 0)
                                    TextCustom(text: selectedComboDiscoutName, font: REGULAR, size: 16, color: #colorLiteral(red: 0.2499063611, green: 0.2955911756, blue: 0.4130570292, alpha: 1))
                                        .opacity(selectedComboDiscout != -1 ? 1 : 0)
                                }.padding(.leading, 16)
                                Spacer()
                            }
                ...
                VStack (alignment: .trailing, spacing: H(8)) {
                    HStack {
                        TextCustom(text: NSLocalizedString("sale_policy_pay_percent", comment: ""), font: MEDIUM, size: 16, color: #colorLiteral(red: 0.1400775909, green: 0.1216219291, blue: 0.1212796792, alpha: 1))
                        Spacer()
                    }
                    ZStack (alignment: .trailing) {
                        Rectangle()
                        ...
                        HStack {
                            TextCustom(text: selectedComboDiscout == -1 ? "0" : "5", font: REGULAR, size: 16, color: #colorLiteral(red: 0.1422221363, green: 0.1236664429, blue: 0.1232500449, alpha: 1))
                                .padding(.leading, 16)
                            Spacer()
                        }
                        TextCustom(text: "%", font: REGULAR, size: 14, color: #colorLiteral(red: 0.6533299685, green: 0.6326879859, blue: 0.6321712136, alpha: 1))
                            .padding(.trailing, 16)
                    }
                }.padding(.top, H(20))
                    .padding(.horizontal, 16)
                VStack (alignment: .trailing, spacing: H(8)) {
                    HStack {
                        TextCustom(text: NSLocalizedString("sale_policy_pay_discount", comment: ""), font: MEDIUM, size: 16, color: #colorLiteral(red: 0.1400775909, green: 0.1216219291, blue: 0.1212796792, alpha: 1))
                        Spacer()
                    }
                    ZStack (alignment: .trailing) {
                        Rectangle()
                            ...
                            .foregroundColor(.init(#colorLiteral(red: 0.9111830592, green: 0.9112924337, blue: 0.9111458659, alpha: 1)))
                        HStack {
                            TextCustom(text: selectedComboDiscout == -1 ? "0" : Utils.formatHighNumber(Double("150000000") ?? 0), font: REGULAR, size: 16, color: #colorLiteral(red: 0.9133259654, green: 0.297054708, blue: 0.2958536744, alpha: 1))
                                .padding(.leading, 16)
                            Spacer()
                        }
                ...
                VStack (alignment: .trailing, spacing: H(8)) {
                    ...
                    ZStack (alignment: .trailing) {
                        Rectangle()
                            ...
                            .foregroundColor(.init(#colorLiteral(red: 0.9111830592, green: 0.9112924337, blue: 0.9111458659, alpha: 1)))
                        HStack {
                            TextCustom(text: selectedComboDiscout == -1 ? Utils.formatHighNumber(Double(sumMoney) ?? 0) : Utils.formatHighNumber(Double("2850000000") ?? 0), font: REGULAR, size: 16, color: #colorLiteral(red: 0.9133259654, green: 0.297054708, blue: 0.2958536744, alpha: 1))
                                .padding(.leading, 16)
                            Spacer()
                        }
                        TextCustom(text: "VND", font: REGULAR, size: 14, color: #colorLiteral(red: 0.6533299685, green: 0.6326879859, blue: 0.6321712136, alpha: 1))
            ...
            if selectedComboDiscout != -1 {
                Button(action: {
                    ...
                    ZStack {
                        ...
                        TextCustom(text: NSLocalizedString("sale_policy_payment", comment: ""), font: REGULAR, size: 22, color: #colorLiteral(red: 0.2499063611, green: 0.2955911756, blue: 0.4130570292, alpha: 1))
                    }
                }.buttonStyle(ButtonTapScale())
                    .animation(.easeInOut(duration: 0.1))
                    .padding(.top, H(30))
